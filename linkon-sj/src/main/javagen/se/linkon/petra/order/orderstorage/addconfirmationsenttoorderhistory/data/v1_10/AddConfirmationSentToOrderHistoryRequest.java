...
package se.linkon.petra.order.orderstorage.addconfirmationsenttoorderhistory.data.v1_10;
 ...
 *         &lt;element ref="{http://petra.linkon.se/commonelements/data/v4_6}ExtraInfo" minOccurs="0"/&gt;
 *         &lt;element ref="{http://petra.linkon.se/commonelements/data/v4_6}ExtendedInfo" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "AddConfirmationSentToOrderHistoryRequest")
public class AddConfirmationSentToOrderHistoryRequest
    implements Serializable
{
    ...
    @XmlElement(name = "ExtraInfo", namespace = "http://petra.linkon.se/commonelements/data/v4_6")
    protected String extraInfo;
    @XmlElement(name = "ExtendedInfo", namespace = "http://petra.linkon.se/commonelements/data/v4_6")
