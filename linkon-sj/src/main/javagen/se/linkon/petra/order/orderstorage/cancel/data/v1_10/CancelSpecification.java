...
@XmlRootElement(name = "CancelSpecification")
public class CancelSpecification
    implements Serializable
{
    ...
    protected CancelSpecification.OrderItems orderItems;
     ...
     * @return
     *     possible object is
     *     {@link CancelSpecification.OrderItems }
     *     
     */
    public CancelSpecification.OrderItems getOrderItems() {
        return orderItems;
    }
     ...
     *     
     */
    public void setOrderItems(CancelSpecification.OrderItems value) {
        ...
        implements Serializable
    {
        ...
        protected List<CancelSpecification.OrderItems.OrderItem> orderItem;
         ...
         * {@link CancelSpecification.OrderItems.OrderItem }
         * 
         * 
         */
        public List<CancelSpecification.OrderItems.OrderItem> getOrderItem() {
            if (orderItem == null) {
                orderItem = new ArrayList<CancelSpecification.OrderItems.OrderItem>();
            }
