...
import se.linkon.petra.commonelements.data.v4_6.CountryCodeType;


/**
 * <p>Java class for ReferenceAddressType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ReferenceAddressType"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://petra.linkon.se/commonelements/data/v4_6}CustomerStreetName" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{http://petra.linkon.se/commonelements/data/v4_6}CustomerCityName" minOccurs="0"/&gt;
 *         &lt;element ref="{http://petra.linkon.se/commonelements/data/v4_6}CustomerZipCode" minOccurs="0"/&gt;
 *         &lt;element ref="{http://petra.linkon.se/commonelements/data/v4_6}CountryCode" minOccurs="0"/&gt;
...
@XmlType(name = "ReferenceAddressType", propOrder = {
    "customerStreetName",
...
public class ReferenceAddressType
    implements Serializable
{

    private final static long serialVersionUID = 1234L;
    @XmlElement(name = "CustomerStreetName", namespace = "http://petra.linkon.se/commonelements/data/v4_6")
    ...
    @XmlElement(name = "CustomerCityName", namespace = "http://petra.linkon.se/commonelements/data/v4_6")
    protected String customerCityName;
    @XmlElement(name = "CustomerZipCode", namespace = "http://petra.linkon.se/commonelements/data/v4_6")
    protected String customerZipCode;
    @XmlElement(name = "CountryCode", namespace = "http://petra.linkon.se/commonelements/data/v4_6")
