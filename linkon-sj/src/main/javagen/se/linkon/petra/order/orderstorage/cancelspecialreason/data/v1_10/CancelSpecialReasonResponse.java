 ...
 *       &lt;sequence&gt;
 *         &lt;element name="CancellationReference" type="{http://petra.linkon.se/commonelements/data/v4_6}ReferenceNumberType"/&gt;
 *         &lt;element name="MandatoryRecalculationWarning" type="{http://petra.linkon.se/commonelements/data/v4_6}EmptyType" minOccurs="0"/&gt;
 *         &lt;element name="CreditAmount" type="{http://petra.linkon.se/commoncomplexelements/data/v4_6}PriceVatType"/&gt;
 *         &lt;element name="CreditPoints" type="{http://petra.linkon.se/commonelements/data/v4_6}CreditPointsType"/&gt;
 *         &lt;element name="CancelItemList" type="{http://petra.linkon.se/order/orderstorage/cancelspecialreason/data/v1_10}CancelItemListType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "CancelSpecialReasonResponse")
public class CancelSpecialReasonResponse
    implements Serializable
{

    private final static long serialVersionUID = 1234L;
    @XmlElement(name = "CancellationReference", required = true)
