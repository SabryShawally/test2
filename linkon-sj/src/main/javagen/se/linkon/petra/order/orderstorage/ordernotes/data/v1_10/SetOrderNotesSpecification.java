 ...
 *         &lt;element name="OrderNoteSpecifications" type="{http://petra.linkon.se/order/orderstorage/ordernotes/data/v1_10}OrderNoteSpecifications"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "", propOrder = {
    "salesOrderId",
    "orderLockId",
    "orderNoteSpecifications"
})
@XmlRootElement(name = "SetOrderNotesSpecification")
public class SetOrderNotesSpecification
    implements Serializable
{
    ...
    @XmlElement(name = "OrderNoteSpecifications", required = true)
    protected OrderNoteSpecifications orderNoteSpecifications;
    ...
    /**
     * Gets the value of the orderNoteSpecifications property.
     * 
     * @return
     *     possible object is
     *     {@link OrderNoteSpecifications }
     *     
     */
    public OrderNoteSpecifications getOrderNoteSpecifications() {
        return orderNoteSpecifications;
    }

    /**
     * Sets the value of the orderNoteSpecifications property.
     * 
     * @param value
     *     allowed object is
     *     {@link OrderNoteSpecifications }
     *     
     */
    public void setOrderNoteSpecifications(OrderNoteSpecifications value) {
        this.orderNoteSpecifications = value;
    }

    public boolean isSetOrderNoteSpecifications() {
        return (this.orderNoteSpecifications!= null);
    }
