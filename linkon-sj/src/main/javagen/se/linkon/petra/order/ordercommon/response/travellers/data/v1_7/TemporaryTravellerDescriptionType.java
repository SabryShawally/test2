...
/**
 * 
 * 				Describes a temporary traveller that is connected
 * 				to any order item(s) described in the response. A temporary
 * 				traveller is known primarily by name in combination with the
 * 				traveller number (RENNR).
 * 			
 * 
 * <p>Java class for TemporaryTravellerDescriptionType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TemporaryTravellerDescriptionType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "TemporaryTravellerDescriptionType", propOrder = {
    "firstName",
    "lastName",
    "birthDate",
    "passportNumber",
...
public class TemporaryTravellerDescriptionType
