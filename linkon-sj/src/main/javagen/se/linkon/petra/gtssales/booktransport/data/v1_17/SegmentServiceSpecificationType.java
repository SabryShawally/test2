 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConsumerSpecification" type="{http://petra.linkon.se/gtssales/booktransport/data/v1_17}ConsumerSpecificationType"/&gt;
 ...
 *         &lt;element ref="{http://petra.linkon.se/commonelements/data/v4_6}TransportSegmentsOrigin" minOccurs="0"/&gt;
 *         &lt;element name="ResplusFlag" type="{http://petra.linkon.se/commonelements/data/v4_6}EmptyType" minOccurs="0"/&gt;
 *         &lt;element name="SegmentSpecification" type="{http://petra.linkon.se/gtssales/booktransport/data/v1_17}SimpleSegmentSpecificationType"/&gt;
    ...
    implements Serializable
{
    ...
    @XmlElement(name = "TransportSegmentsOrigin", namespace = "http://petra.linkon.se/commonelements/data/v4_6")
    @XmlSchemaType(name = "string")
    protected TransportSegmentsOriginType transportSegmentsOrigin;
    @XmlElement(name = "ResplusFlag")
    protected EmptyType resplusFlag;
    ...
    /**
     * 
     * 						Requested price group, type of ticket (fare level
     * 						-
     * 						e.g. standard class ticket, business class ticket).
     * 						Available
     * 						price groups previously received from
     * 						operation
     * 						getValidPriceGroups.
     * 					
     * 
    ...
    /**
     * 
     * 						Set to "J" to request a service payable with
     * 						loyalty
     * 						program points.
     * 					
     * 
    ...
    /**
     * 
     * 						Specify a Promotioncode to use a promotion.
     * 					
     * 
     * @return
     *     possible object is
    ...
    /**
     * 
     * 						Specifies the type of travel, i.e. Single ("E"),
     * 						Round trip ("T"), Return only ("R"). "E" is the most
     * 						common value.
     * 					
     * 
     * @return
    ...
    /**
     * Gets the value of the resplusFlag property.
     * 
     * @return
     *     possible object is
     *     {@link EmptyType }
     *     
     */
    public EmptyType getResplusFlag() {
        return resplusFlag;
    }

    /**
     * Sets the value of the resplusFlag property.
     * 
     * @param value
     *     allowed object is
     *     {@link EmptyType }
     *     
     */
    public void setResplusFlag(EmptyType value) {
        this.resplusFlag = value;
    }

    public boolean isSetResplusFlag() {
        return (this.resplusFlag!= null);
    }
