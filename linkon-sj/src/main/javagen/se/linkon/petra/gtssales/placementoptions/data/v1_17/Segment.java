...
/**
 * Specifies a segment that we wish to query for
 * 				placement options.
 * 				Each segment should be qualified with a unique (unique for the
 * 				itinerary) segment reference.
 * 			
 * 
    ...
    implements Serializable
{
    ...
    /**
     * Indicates whether placement can (or must) be
     * 						booked on a segment. Segments where this is EJBO will be ignored
     * 						by this operation.
     * 
     * @return
     *     possible object is
