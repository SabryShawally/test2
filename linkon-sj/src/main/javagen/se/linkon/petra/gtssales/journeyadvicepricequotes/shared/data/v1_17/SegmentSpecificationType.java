...
/**
 * Specifies a segment, i.e. a subset of the entire
 * 				travel route.
 * 				A segment contains information about departure- and
 * 				arrival
 * 				locations, departure- and arrival dates/times as well as
 * 				information
 * 				concerning the transport involved.
 * 			
 * 
    ...
    implements Serializable
{
    ...
    /**
     * Use when a specific booking class must be
     * 						provided, i.e. when a booking class was provided for this segment
     * 						in the timetable response.
     * 					
     * 
     * @return
     *     possible object is
