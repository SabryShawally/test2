...
import se.linkon.petra.gtssales.journeyadvicepricequotes.shared.data.v1_17.JourneyAdviceSpecificationType;
 ...
 *         &lt;element name="JourneyAdviceSpecification" type="{http://petra.linkon.se/gtssales/journeyadvicepricequotes/shared/data/v1_17}JourneyAdviceSpecificationType"/&gt;
...
@XmlRootElement(name = "GetJourneyAdviceDetailedPriceQuotesSpecification")
public class GetJourneyAdviceDetailedPriceQuotesSpecification
    implements Serializable
{
    ...
    protected JourneyAdviceSpecificationType journeyAdviceSpecification;
     ...
     *     
     */
    public JourneyAdviceSpecificationType getJourneyAdviceSpecification() {
        return journeyAdviceSpecification;
    }

    /**
     * Sets the value of the journeyAdviceSpecification property.
     * 
     * @param value
     *     allowed object is
     *     {@link JourneyAdviceSpecificationType }
     *     
     */
    public void setJourneyAdviceSpecification(JourneyAdviceSpecificationType value) {
        this.journeyAdviceSpecification = value;
    }

    public boolean isSetJourneyAdviceSpecification() {
        return (this.journeyAdviceSpecification!= null);
    }
