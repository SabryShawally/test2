 ...
 *         &lt;element name="ConsumerItineraryDescriptions" type="{http://petra.linkon.se/gtssales/journeyadvicepricequotes/overview/data/v1_17}ConsumerItineraryDescriptionsType"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    implements Serializable
{
    ...
    /**
     * 
     * 						This identifier needs to be passed along to the booking request in order to correctly book the journey and obtain the proper price.
     * 					
     * 
     * @return
     *     possible object is
